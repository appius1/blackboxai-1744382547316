    ...
    <>
      ...
      `}>
        ...
        <div className="p-4 border-t border-indigo-800">
          <div className="flex items-center space-x-3 group cursor-pointer hover:bg-indigo-800 p-3 rounded-lg transition-all duration-200">
            <img
              src="https://ui-avatars.com/api/?name=Admin&background=6366f1&color=fff"
              alt="User avatar"
              className="h-10 w-10 rounded-full border-2 border-indigo-300 group-hover:border-white transition-colors duration-200"
            />
            <div>
